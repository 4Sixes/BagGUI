VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} South 
   Caption         =   "South"
   ClientHeight    =   8790
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   2475
   OleObjectBlob   =   "South.frx":0000
   ShowModal       =   0   'False
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "South"
...
Private Sub ToggleButtonSouth_Click()
Call MakeTransparentSouth
End Sub
