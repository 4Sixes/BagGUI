VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} West 
   Caption         =   "West"
   ClientHeight    =   8835
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   2475
   OleObjectBlob   =   "West.frx":0000
   ShowModal       =   0   'False
...
Private Sub ToggleButtonWest_Click()
Call MakeTransparentWest
End Sub
